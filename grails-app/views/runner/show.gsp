...
<html>
    ...
    <body>
        ...
        <div id="show-runner" class="content scaffold-show" role="main">
            ...
            <f:display bean="runner" />
            <g:form resource="${this.runner}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.runner}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
